...
void GstQtGLVideoSinkBase::colorbalance_init(GstColorBalanceInterface *iface, gpointer data)
{
    Q_UNUSED(data);
    iface->list_channels = GstQtGLVideoSinkBase::colorbalance_list_channels;
    iface->set_value = GstQtGLVideoSinkBase::colorbalance_set_value;
    iface->get_value = GstQtGLVideoSinkBase::colorbalance_get_value;
    iface->get_balance_type = GstQtGLVideoSinkBase::colorbalance_get_balance_type;
}
